...
def import_data_to_odoo(models, uid, odoo_model, data):
    ...
    for record in data:
        ...
        hr_applicant_academic = models.execute_kw(
            ...
            uid,
            odoo_password,
            "hr.applicant.academic",
            "search",
            [
                [("tt_id", "=", record["iCandidateAcademicId"])],   
            ]
        )
        ...
        if employee_id:
            academic_data = {
                ...
                "institute_name": record["vInstitute"],
                "pass_year": record["vPassYear"],
                "percentage": record["vPercentage"],
            }
            ...
            record1 = models.execute_kw(
                ...
                "hr.applicant",
                "write",
                [employee_id, {"academic_data_ids": [(0, 0, academic_data)]}],
            )
            print("\n\nemployee_id:", record1)
